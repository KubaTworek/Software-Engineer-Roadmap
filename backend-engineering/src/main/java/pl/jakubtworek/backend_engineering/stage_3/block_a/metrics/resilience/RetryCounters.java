package pl.jakubtworek.backend_engineering.stage_3.block_a.metrics.resilience;
...
public record RetryCounters(
    ...
    public RetryCounters {
        ...
        if (successfulRetries > totalAttempts - originalRequests) throw new IllegalArgumentException("successfulRetries cannot exceed retry attempts");
    }
}
